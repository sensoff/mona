...
class FilesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['Files']))
		{
			...
			$model->url=Yii::app()->params['imagePath'].'files/'.$model->img->getName();
			if($model->save()){
				if($model->img){
					$model->img->saveAs(realpath(Yii::getPathOfAlias('webroot').'/../images/files').'/'.$model->file);
				}
	...
	public function actionDelete($id)
	{
		...
		if(!isset($_GET['ajax']))
			$this->redirect(isset($_POST['returnUrl']) ? $_POST['returnUrl'] : array('/files/index'));
	}
	...
	{
		$files=Files::GetFiles($page);
		$pagecount=Files::getPagesCount();
