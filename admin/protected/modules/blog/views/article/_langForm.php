...
<div class="conteiner tactions cell8 form_title asbutton <?php echo $lang->name;if($lang->id == 1){echo ' active';}?>" atr="<?php echo $lang->name; ?>">
				...
				<div class="conteiner" id="<?php echo $lang->name; ?>" style="<?php echo $style ?>">
					...
					<div class="table cell8 prosmotr">
						...
						<div class="tbody">
							<?php $this->renderPartial('application.views.site._formLine', array('form'=>$form, 'model'=>$model, 'req'=>$req, 'elem'=>'name_lang'.$lang->id, 'elemtype'=>'textfield'))?>
							<?php $this->renderPartial('application.views.site._formLine', array('form'=>$form, 'model'=>$model, 'req'=>$req, 'elem'=>'main_text_lang'.$lang->id, 'elemtype'=>'textedit'))?>						
						</div>	
