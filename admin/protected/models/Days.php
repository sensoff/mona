...
class Days extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('', 'required'),
			array('one_day_doff, thow_day_doff, three_day_doff, four_day_doff, five_day_doff, six_day_doff, seven_day_doff', 'numerical', 'integerOnly'=>true),
